...
function calculator() {
  ...
  var calcInputs = document.querySelectorAll('.calculating__choose input');
  var calcButtonsGender = document.querySelectorAll('#gender .calculating__choose-item');
  var calcButtonsActivity = document.querySelectorAll('.calculating__choose_big .calculating__choose-item');
  var gender, growth, weight, age, activityRatio;

  if (localStorage.getItem('gender')) {
    document.querySelector("#gender #".concat(localStorage.getItem('gender'))).classList.add('calculating__choose-item_active');
  } else {
  ...
  if (localStorage.getItem('activity-ratio')) {
    document.querySelector("#activity-ratio #".concat(localStorage.getItem('activity-ratio'))).classList.add('calculating__choose-item_active');
  } else {
  ...
  function setActiveButton(buttonsCollection) {
    buttonsCollection.forEach(function (item) {
...
function cards() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_7__.getResources)('http://localhost:3000/menu').then(function (data) {
...
function forms(formSelector, modalTimerId) {
  // FORMS
  // Получаем все формы с сайта что бы навесить на них нашу функцию
  var forms = document.querySelectorAll(formSelector); // Создаем объект сообщений

  var message = {
    loading: "img/form/spinner.svg",
    success: "Thank you, cya!",
    failure: "Sorry, something went wrong..."
  }; // Функция для постинга данных на сервер
  ...
  function showThanksModal(message) {
    ...
    (0,_modals__WEBPACK_IMPORTED_MODULE_9__.showModal)('.modal', modalTimerId);
    ...
    setTimeout(function () {
      ...
      (0,_modals__WEBPACK_IMPORTED_MODULE_9__.hideModal)('.modal');
    }, 4000);
  }
}
...
function modals(triggerSelector, modalSelector, modalTimerId) {
  // MODALS
  var triggerBtns = document.querySelectorAll(triggerSelector),
  ...
  triggerBtns.forEach(function (button) {
...
function slider(_ref) {
  ...
  function addZeroToCounter(count) {
    ...
    if (count <= 9) return "0".concat(count);
  }
}
...
function tabs(tabsSeletor, tabsContentSelector, tabsParentSelector, activeClass) {
  // TABS
  var tabs = document.querySelectorAll(tabsSeletor),
...
function timer(deadLine, timerSelector) {
  ...
  function getTimeRemaining(endTime) {
    var __t = Date.parse(endTime) - Date.parse(new Date());

    var days = Math.floor(__t / (1000 * 60 * 60 * 24));
    var hours = Math.floor(__t / (1000 * 60 * 60) % 24);
    var minutes = Math.floor(__t / (1000 * 60) % 60);
    var seconds = Math.floor(__t / 1000 % 60);
    return {
      'total': __t,
      'days': days,
      'hours': hours,
  ...
  function setClock(selector, endTime) {
    ...
    function updateClock() {
      var __t = getTimeRemaining(endTime);
...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimerId = setTimeout(function () {
    return (0,_modules_modals__WEBPACK_IMPORTED_MODULE_4__.showModal)('.modal', modalTimerId);
  }, 30000);
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])(deadLine, '.timer');
